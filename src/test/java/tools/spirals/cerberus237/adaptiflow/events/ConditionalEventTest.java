...
public class ConditionalEventTest {
    ...
    private ConditionalEvent<Double> conditionalEvent;
    ...
    public void setUp() {
        ...
        ConditionEvaluator<Double> conditionEvaluator = value -> value >= 50.0;
        conditionalEvent = new ConditionalEvent<>(collector, conditionEvaluator);
        observer = new TestObserver<>();
        conditionalEvent.subscribe(observer);
    }

    @Test
    public void testObserveNotifiesObserverWhenConditionIsTrue() {
        collector.setValue(60.0); // Value meets the condition
        conditionalEvent.observe();
    ...
    @Test
    public void testObserveDoesNotNotifyObserverWhenConditionIsFalse() {
        collector.setValue(40.0); // Value does not meet the condition
        conditionalEvent.observe();
