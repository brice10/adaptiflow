...
/**
 * The {@link ConditionEvaluatorComparableDataType} interface defines a contract for evaluating
 ...
 */
public interface ConditionEvaluatorComparableDataType<T extends Comparable<? super T>> extends ConditionEvaluator<T> {
